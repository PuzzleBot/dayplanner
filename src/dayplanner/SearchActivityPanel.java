...
public class SearchActivityPanel extends JPanel{
    ...
    public SearchActivityPanel(){
        ...
        gridPanel.add(new JLabel("Keywords: "));
        ...
        JLabel areaLabel = new JLabel("Search Results");
     ...
     */
    public void enterSearchResults(String results){
        messageArea.setText(results);
    }
    ...
    /**
     * Activity type input string accessor
     */
    ...
    /**
     * Keyword input retrieval
     */
    public String getActivityKeys(){
